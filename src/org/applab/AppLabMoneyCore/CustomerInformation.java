...
public class CustomerInformation {
    ...
    public static CustomerInformation getNewCustomerInfo(String targetMsisdn){
        ...
        try {            
            ...
            PreparedStatement stm = cn.prepareStatement(String.format(sb.toString(),targetMsisdn));
            
            ResultSet result = stm.executeQuery();
            while(result.next()){
                custInfo = new CustomerInformation();
                custInfo.setAccountTypeBitmap(result.getInt("ACCOUNT_TYPE_BITMAP"));                
                ...
                custInfo.setMsisdn((result.getString("MSISDN")==null) ? "" : result.getString("MSISDN").trim());
                custInfo.setPinCode((result.getString("PIN_CODE")==null) ? "" : result.getString("PIN_CODE").trim());             
    ...
    public static CustomerInformation getCustomerAccountInfo(String targetMsisdn){
        ...
        try {            
            ...
            while(result.next()){
                custInfo = new CustomerInformation();
                custInfo.setAccountTypeBitmap(result.getInt("ACCOUNT_TYPE_BITMAP"));                
                custInfo.setAgentCode((result.getString("AGENT_CODE")==null) ? "" : result.getString("AGENT_CODE").trim());
                custInfo.setAliasName((result.getString("ALIAS_NAME")==null) ? "" : result.getString("ALIAS_NAME").trim());
                custInfo.setCompanyName((result.getString("COMPANY_NAME")==null) ? "" : result.getString("COMPANY_NAME").trim());
                custInfo.setCustomerId(result.getInt("CUSTOMER_ID"));
                if (result.getInt("ENABLED_FLG") == 1){
                    custInfo.setEnabled(true);
                }
                ...
                custInfo.setLastName((result.getString("LAST_NAME") == null) ? "" : result.getString("LAST_NAME").trim());
                custInfo.setOtherNames((result.getString("OTHER_NAMES") == null) ? "" : result.getString("OTHER_NAMES").trim());
                ...
                custInfo.setMsisdn((result.getString("MSISDN")==null) ? "" : result.getString("MSISDN").trim());
                custInfo.setPinCode((result.getString("PIN_CODE")==null) ? "" : result.getString("PIN_CODE").trim());
                custInfo.setReferenceTree((result.getString("REFERENCE_TREE")==null) ? "" : result.getString("REFERENCE_TREE").trim());
                custInfo.setRegistrarCustomerId(result.getInt("REGISTRAR_CUSTOMER_ID"));
                ...
                accountInfo.setBlockedBalance(result.getDouble("BLOCKED_BALANCE"));
    ...
    public static CustomerInformation getCustomerAccountInfoByAgentCode(String targetAgentCode){
        Connection cn = null;
        CustomerInformation custInfo = null;
        AccountInformation accountInfo = null;
        StringBuffer sb = null;
        ...
        try {            
            ...
            PreparedStatement stm = cn.prepareStatement(String.format(sb.toString(),targetAgentCode));
    ...
    public static boolean createCustomerAccount(String phoneMsisdn, String lastName, String otherNames, String physicalAddress,
                                                String homeDistrict, String idType, String idNo, String nationality, Date dateOfBirth,
                                                String placeOfBirth, String defaultPinCode, long registrarCustomerId) {
        Connection cn = null;
        ...
        try {
            ...
            stm = cn.prepareStatement(String.format(sqlQuery, phoneMsisdn,lastName, otherNames,physicalAddress,homeDistrict,idType,idNo,
                    nationality,placeOfBirth,defaultPinCode,Long.toString(registrarCustomerId)));
    ...
    public static ValidationReturnInformation validateCustomerAccountInfo(CustomerInformation theCustAccountInfo, boolean targetCustAccountIsSource)  {
        ...
        try {
            ...
            if (targetCustAccountIsSource) {
                ...
                else if (theCustAccountInfo.isLocked() || !theCustAccountInfo.isEnabled()) {                        
    ...
    public static boolean createAccount(long customerId, int accountTypeBitmap) {
        ...
        try {
            ...
            stm = cn.prepareStatement(String.format(sqlQuery, Long.toString(customerId), Integer.toString(accountTypeBitmap)));
    ...
    public static boolean changePinCode(long customerId, String newPinCode) throws SQLException {
        Connection cn = null;
        PreparedStatement stm = null;
        StringBuilder sb = null;
        int dbStatusCode = 0;
        ...
        try {
            ...
            stm = cn.prepareStatement(String.format(sqlQuery, newPinCode, customerId));
    ...
    public static boolean lockCustomer(long customerId) throws SQLException{
        ...
        try {
            ...
            sb = new StringBuilder();
            sb.append("UPDATE CUSTOMERS SET LOCKED_FLG= 1 AND LOCKED_REASON = 'INVALID PINCODE' WHERE CUSTOMER_ID = %s ");           
            sqlQuery = sb.toString();

            stm = cn.prepareStatement(String.format(sqlQuery, Long.toString(customerId)));
    ...
    public static boolean resetInvalidPinCount(long customerId) throws SQLException{
        Connection cn = null;
        PreparedStatement stm = null;
        StringBuilder sb = null;
        int dbStatusCode = 0;
    ...
    public static String getDisplayNames(CustomerInformation theCustomerInfo, boolean preferCompanyName){
        String displayName = "";
        String otherNames = "";
        String lastName = "";
        String fullNames = "";
        ...
        try {
            ...
            otherNames = ((theCustomerInfo.getOtherNames() == null) ? "" : theCustomerInfo.getOtherNames());
            lastName =  ((theCustomerInfo.getLastName() == null) ? "" : theCustomerInfo.getLastName());
            ...
            if(preferCompanyName && theCustomerInfo.getCompanyName() != null){
                ...
                if(SystemConfigInfo.getSmsMsgSubDisplayFormat() == 2) {
                    displayName = theCustomerInfo.getMsisdn().concat(" ").concat(fullNames); 
                }
