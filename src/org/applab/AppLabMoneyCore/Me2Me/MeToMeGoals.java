...
public class MeToMeGoals extends ArrayList<MeToMeGoal> {
    ...
    public static MeToMeGoals getAllGoalsByGoalTypeId(int goalTypeId){
        ...
        try {  
            ...
            String sqlQuery = String.format(sb.toString(),Long.toString(goalTypeId));
            meToMeGoals = executeQueryToRetrieveMeToMeGoals(sqlQuery);
            return meToMeGoals;
        }
        catch (Exception ex) {
    ...
    public static MeToMeGoals getAllGoalsByCustomerId(long customerId){
        ...
        try {  
            ...
            String sqlQuery = String.format(sb.toString(),Long.toString(customerId));
            meToMeGoals = executeQueryToRetrieveMeToMeGoals(sqlQuery);
            return meToMeGoals;
        }
        catch (Exception ex) {
    ...
    public static MeToMeGoals getActiveGoalsByCustomerAndGoalType(long customerId, String goalType){
        MeToMeGoals meToMeGoals = null;
        StringBuffer sb = null;
        ...
        try {  
            ...
            //TODO: I may have to use GOAL_NAME instead of GOAL_TYPE_ID to avoid trouble
            String sqlQuery = String.format(sb.toString(),Long.toString(customerId), goalType, goalType);
            meToMeGoals = executeQueryToRetrieveMeToMeGoals(sqlQuery);
            return meToMeGoals;
        }
        catch (Exception ex) {
    ...
    public static MeToMeGoals getActiveGoalsByCustomerAndGoalCode(long customerId, String goalCode){
        MeToMeGoals meToMeGoals = null;
        StringBuffer sb = null;
        ...
        try {  
            ...
            String sqlQuery = String.format(sb.toString(),Long.toString(customerId), goalCode);
            meToMeGoals = executeQueryToRetrieveMeToMeGoals(sqlQuery);
            return meToMeGoals;
        }
        catch (Exception ex) {
    ...
    public static MeToMeGoals getUnRedeemedGoalsByCustomerAndGoalType(long customerId, String goalType){
        MeToMeGoals meToMeGoals = null;
        StringBuffer sb = null;
    ...
    private static MeToMeGoals executeQueryToRetrieveMeToMeGoals(String sqlQuery) {
        ...
        try {  
            ...
            while(result.next()){
                ...
                meToMeGoal.setAlertOption((result.getString("ALERT_OPTION")==null) ? "" : result.getString("ALERT_OPTION").trim());
                meToMeGoal.setCreatedTimestamp((result.getDate("CREATED_TIMESTAMP")==null) ? null : result.getDate("CREATED_TIMESTAMP"));
                meToMeGoal.setCustomerId(result.getLong("CUSTOMER_ID"));
                meToMeGoal.setGoalCode((result.getString("GOAL_CODE")==null) ? "" : result.getString("GOAL_CODE").trim());
                meToMeGoal.setGoalId(result.getInt("GOAL_ID"));
                meToMeGoal.setGoalName((result.getString("GOAL_NAME")==null) ? "" : result.getString("GOAL_NAME").trim());
                ...
                meToMeGoal.setLiquidityOption((result.getString("LIQUIDITY_OPTION")==null) ? "" : result.getString("LIQUIDITY_OPTION").trim());
                meToMeGoal.setMaturityDate((result.getDate("MATURITY_DATE")==null) ? null : result.getDate("MATURITY_DATE"));
                if(result.getInt("IS_MATURED") == 1) {
                    meToMeGoal.setIsMatured(true);
                }
                if(result.getInt("IS_REDEEMED") == 1) {
                    meToMeGoal.setIsRedeemed(true);
                    meToMeGoal.setDateRedeemed((result.getDate("DATE_REDEEMED")==null) ? null : result.getDate("DATE_REDEEMED"));
                }                
